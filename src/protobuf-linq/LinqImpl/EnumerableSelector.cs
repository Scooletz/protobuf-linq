...
{
    public class EnumerableSelector<TSource, TResult> : IEnumerable<TResult>
    {
        ...
        public EnumerableSelector(RuntimeTypeModel model, PrefixStyle prefix, Stream source, Func<TSource, int, bool> @where, Func<TSource, int, TResult> selector)
        {
            _prefix = prefix;
            _source = source;
            _where = @where;
